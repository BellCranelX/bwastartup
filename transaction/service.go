...
type Service interface {
	GetTransactionByCampaignID(input GetTransactionInput) ([]Transaction, error)
...
func (s *service) GetTransactionByCampaignID(input GetTransactionInput) ([]Transaction, error) {
