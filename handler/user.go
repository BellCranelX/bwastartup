...
func (h *userHandler) RegisterUser(c *gin.Context) {
	...
	//struct di atas kita passsing sebagai parameter service
...
func (h *userHandler) Login(c *gin.Context) {
	...
	//mapping dari user input ke input struct
...
func (h *userHandler) CheckEmailAvailability(c *gin.Context) {
	...
	// service akan memanggil repository - email apakah sudah ada atau belum.
	// repository -db
...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	...
	//JWT (hardcode, seakan2 user yang login id =1 )
